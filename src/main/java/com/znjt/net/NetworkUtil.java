...
public class NetworkUtil {
    ...
    public static void main(String[] args) throws Exception{
        for (NetworkInterface nic : getNICs(Filter.PHYICAL_ONLY, Filter.UP)) {
            List<InterfaceAddress> nicInterfaceAddresses = nic.getInterfaceAddresses();
            Optional.ofNullable(nicInterfaceAddresses).ifPresent(interfaceAddresses->{
                interfaceAddresses.forEach(x->{
